...
module.exports = {
    ...
    guide: {
      ...
      en: {
        body: " {pn} on: تفعيل رسالة المغادرة" +
          ...
          "\n {pn} text [<المحتوى> | reset]: تحرير محتوى النص أو إعادة تعيينه إلى الافتراضي، الاختصارات المتاحة:" +
          "\n + {userName}: اسم العضو الذي غادر المجموعة" +
          "\n + {userNameTag}: اسم العضو الذي غادر المجموعة (علامة)" +
          "\n + {boxName}: اسم محادثة المجموعة" +
          "\n + {type}: مغادرة/طرد من قبل الإدارة" +
          "\n + {session}: الجلسة في اليوم" +
          "\n\n مثال:" +
          "\n {pn} text {userName} قام بـ {type} المجموعة، نراكم مرة أخرى 🤧" +
          "\n" +
          "\n رد أو أرسل رسالة مع ملف مع المحتوى {pn} file: لإضافة ملف مرفق إلى رسالة المغادرة (صورة، فيديو، صوت)" +
          "\n\nمثال:" +
  ...
  langs: {
    ...
    en: {
      ...
      edited: "تم تحرير محتوى رسالة المغادرة لمجموعتك إلى:\n%1",
      ...
      missingFile: "يرجى الرد على هذه الرسالة مع ملف صورة/فيديو/صوت",
      addedFile: "تم إضافة %1 ملف مرفق إلى رسالة المغادرة الخاصة بك"
    }
  },
