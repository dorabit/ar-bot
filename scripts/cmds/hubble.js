...
module.exports = {
  ...
  langs: {
    ...
    en: {
      invalidDate: "التاريخ المدخل غير صحيح، يرجى إعادة إدخال التاريخ بالتنسيق mm-dd",
      noImage: "لا توجد صور متاحة لهذا اليوم"
    }
  },
...
const monthText = ['يناير', 'فبراير', 'مارس', 'أبريل', 'مايو', 'يونيو', 'يوليو', 'أغسطس', 'سبتمبر', 'أكتوبر', 'نوفمبر', 'ديسمبر'];
