...
module.exports = {
  ...
  langs: {
    ...
    en: {
      invalidDatabase: "❌ يرجى التحويل إلى قاعدة بيانات SQLite في الإعدادات ثم إعادة تشغيل البوت لاستخدام هذا الأمر",
      missingFile: "❌ لم تقم بنسخ ملف البيانات %1 إلى مجلد database/data",
      formatInvalid: "❌ تنسيق البيانات غير صالح",
      error: "❌ حدث خطأ:\n%1: %2",
      successThread: "✅ تمت مزامنة بيانات المحادثة من JSON إلى SQLite بنجاح!",
      successUser: "✅ تمت مزامنة بيانات المستخدم من JSON إلى SQLite بنجاح!",
      successDashboard: "✅ تمت مزامنة بيانات لوحة التحكم من JSON إلى SQLite بنجاح!",
      successGlobal: "✅ تمت مزامنة البيانات العامة من JSON إلى SQLite بنجاح!"
    }
