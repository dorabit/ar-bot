...
module.exports = {
  config: {
    ...
    description: {
      ...
      en: "ابحث عن معنى الايموجي"
    },
    category: "wiki",
    guide: {
      vi: "   {pn} <emoji>: Tìm nghĩa của emoji",
      en: "  {pn} <الإيموجي>: ابحث عن معنى الإيموجي
      "
    }
  },
  ...
  langs: {
    ...
    en: {
      missingEmoji: "⚠️ لم تقم بإدخال إيموجي",
      meaningOfEmoji: "📌 معنى الإيموجي %1:\n\n📄 المعنى الأول: %2\n\n📑 معاني إضافية: %3%4\n\n📄 الشفرة القصيرة: %5\n\n©️ المصدر: %6\n\n📺 فيما يلي صور الإيموجي المعروضة على بعض المنصات:",
      meaningOfWikipedia: "\n\n📝 قم بالرد على هذه الرسالة لعرض المعنى \"%1\" من ويكيبيديا",
      meanOfWikipedia: "📑 معنى \"%1\" على ويكيبيديا:\n%2",
      manyRequest: "⚠️ أرسل البوت عددًا كبيرًا من الطلبات، يرجى المحاولة مرة أخرى لاحقًا",
      notHave: "غير متوفر"
    }
