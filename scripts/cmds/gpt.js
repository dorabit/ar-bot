...
module.exports = {
  ...
  langs: {
    ...
    en: {
      apiKeyEmpty: "يرجى تقديم مفتاح API ل OpenAI في ملف scripts/cmds/gpt.js",
      invalidContentDraw: "يرجى إدخال المحتوى الذي تريد رسمه",
      yourAreUsing: "أنت تستخدم دردشة GPT، يرجى الانتظار حتى ينتهي الطلب السابق",
      processingRequest: "جاري معالجة طلبك، قد تستغرق هذه العملية بضع دقائق، يرجى الانتظار",
      invalidContent: "يرجى إدخال المحتوى الذي تريد الدردشة عنه",
      error: "حدث خطأ\n%1",
      clearHistory: "تم حذف تاريخ الدردشة مع GPT"
    }
