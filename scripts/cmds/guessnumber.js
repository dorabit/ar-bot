...
module.exports = {
  config: {
    ...
    guide: {
      ...
      en: "{pn} [4 | 5 | 6] [single | multi]: إنشاء لعبة جديدة، مع:" + "\n 4 5 6 هو عدد الأرقام للرقم المراد تخمينه، الافتراضي هو 4." + "\n single | multi هو وضع اللعبة، single هو لاعب واحد، multi هو لاعبون متعددون، الافتراضي هو single." + "\n مثال:" + "\n {pn}" + "\n {pn} 4 single" + "\n" + "\n كيفية اللعب: يرد اللاعب على رسالة البوت وفقًا للقواعد التالية:" + "\n لديك " + rows.map(item => `${item.row} مرات (${item.col} أرقام)`).join(", ") + "." + "\n بعد كل تخمين، ستتلقى تلميحات إضافية حول عدد الأرقام الصحيحة (المعروضة على اليسار) وعدد الأرقام الصحيحة في المكان الصحيح (المعروضة على اليمين)." + "\n ملاحظة: الرقم يتكون من أرقام من 0 إلى 9، كل رقم يظهر مرة واحدة فقط ويمكن أن يبدأ الرقم بـ 0." + "\n\n {pn} rank <page>: عرض الترتيب." + "\n {pn} info [<uid> | <@tag> | <reply> | <empty>]: عرض معلومات الترتيب الخاصة بك أو لشخص آخر." + "\n {pn} reset: إعادة تعيين الترتيب (للمشرفين فقط)."
  ...
  langs: {
    ...
    en: {
      charts: "🏆 | الترتيب:\n%1",
      pageInfo: "صفحة %1/%2",
      noScore: "⭕ | لا يوجد أحد قد سجل نقاط.",
      noPermissionReset: "⚠️ | ليس لديك إذن لإعادة تعيين الترتيب.",
      notFoundUser: "⚠️ | تعذر العثور على المستخدم برقم الهوية %1 في الترتيب.",
      userRankInfo: "🏆 | معلومات الترتيب:\nالاسم: %1\nالنقاط: %2\nعدد الألعاب: %3\nعدد الفوز: %4\n%5\nعدد الخسارة: %6\nنسبة الفوز: %7%\nإجمالي وقت اللعب: %8",
      digits: "%1 أرقام: %2",
      resetRankSuccess: "✅ | تم إعادة تعيين الترتيب بنجاح.",
      invalidCol: "⚠️ | يرجى إدخال عدد الأرقام للرقم المراد تخمينه هو 4 أو 5 أو 6",
      invalidMode: "⚠️ | يرجى إدخال وضع اللعبة هو فردي أو متعدد",
      created: "✅ | تم إنشاء اللعبة بنجاح.",
      gameName: "لعبة تخمين الأرقام",
      gameGuide: "⏳ | كيفية اللعب:\nلديك %1 محاولات.\nبعد كل محاولة، ستتلقى تلميحات إضافية حول عدد الأرقام الصحيحة (المعروضة على اليسار) وعدد الأرقام الصحيحة في المكان الصحيح (المعروضة على اليمين).",
      gameNote: "📄 | ملاحظة:\nالرقم يتكون من أرقام من 0 إلى 9، كل رقم يظهر مرة واحدة فقط ويمكن أن يبدأ الرقم بـ 0.",
      replyToPlayGame: "🎮 | قم بالرد على الرسالة أدناه بصورة %1 أرقام التي تخمنها للعب اللعبة.",
      invalidNumbers: "⚠️ | يرجى إدخال %1 أرقام التي تريد تخمينها",
      win: "🎉 | مبروك! لقد خمنت الرقم %1 بعد %2 محاولات وتلقيت %3 نقاط إضافية.",
