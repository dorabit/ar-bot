...
module.exports = {
  config: {
    ...
    guide: {
      ...
      en: " {pn} <محادثة | مستخدم | لوحة التحكم | عام | الكل>: مزامنة البيانات من JSON إلى MongoDB\n\n ستقوم هذه العملية بتحديث البيانات الموجودة في MongoDB إذا كانت متاحة مسبقًا"
    }
  },
  ...
  langs: {
    ...
    en: {
      invalidDatabase: "❌ يرجى التحويل إلى قاعدة بيانات MongoDB في الإعدادات ثم إعادة تشغيل البوت لاستخدام هذا الأمر",
      missingFile: "❌ لم تقم بنسخ ملف البيانات %1 إلى مجلد database/data",
      formatInvalid: "❌ تنسيق البيانات غير صالح",
      error: "❌ حدث خطأ:\n%1: %2",
      successThread: "✅ تمت مزامنة بيانات المحادثة من JSON إلى MongoDB بنجاح!",
      successUser: "✅ تمت مزامنة بيانات المستخدم من JSON إلى MongoDB بنجاح!",
      successDashboard: "✅ تمت مزامنة بيانات لوحة التحكم من JSON إلى MongoDB بنجاح!",
      successGlobal: "✅ تمت مزامنة البيانات العامة من JSON إلى MongoDB بنجاح!"
    }
  },
